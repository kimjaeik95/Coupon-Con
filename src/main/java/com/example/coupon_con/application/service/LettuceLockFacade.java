...
import com.example.coupon_con.infrastructure.RedisLettuceLockAdapter;
...
public class LettuceLockFacade {
    ...
    private final RedisLettuceLockAdapter redisLockAdapter;
    ...
    public Coupon issueCouponWithLettuceLock(Long memberId, Long couponId) throws InterruptedException {
        ...
        // 또 클라이언트가 생성하므로 락 ID를 직접 관리 할 수 있다.
